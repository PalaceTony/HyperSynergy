...
def test(
    total_test_batches, data_test, model, device, best_step, best_MSE, saved_model, sup
):
    # load state dict
    ...
    for P in range(20):
        ...
        for test_step in range(total_test_batches):
            ...
            support_target_images = np.concatenate(
                [support_set_images_, target_image_], axis=1
            )
            ...
            test_data = TestbedDataset(
                support_target_images, drug_features, cell_features, codes
            )
            test_data1 = TestbedDataset1(
                support_target_images, drug_features, cell_features, codes
            )
            ...
            for batch_idx, data in enumerate(test_loader):
                ...
                for batch_idx1, data1 in enumerate(test_loader1):
                    if batch_idx1 == batch_idx:
                        ...
                        _, _, _, test_loss, val_output, val_target = model.run_batch(
                            data, data1, b, False
                        )
        ...
        save_statistics(
            ...
            [
                ...
                spearman(total_labels, total_preds),
    ...
    print(
        "Meta test Loss: {:0.05f}".format(total_c_loss),
        total_c_rmse,
        total_c_spearman,
        total_c_pearson,
        total_c_r2,
...
if __name__ == "__main__":
    ...
    logss = "{}way{}shot , with {} tasks, test_batch is{},mse is{},method is {},step is{} ".format(
        samples_support,
        samples_query,
        batch_size,
        total_test_batches,
